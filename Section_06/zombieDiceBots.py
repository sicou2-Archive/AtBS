...
class MyZombie:
    ...
    def turn(self, gameState):
        ...
        # roll() returns a dictionart with keys 'brains', 'shotgun', and
        ...
        # REPLACE THIS ZOMBIT CODE WITH YOUR OWN:
        brains = 0
...
zombies = (
    ...
    zombiedice.examples.RollsUntilInTheLead(name="Until Leading")
